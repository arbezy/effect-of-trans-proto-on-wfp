...
class Sniffer(object):
    ...
    def start_capture(self, pcap_path=None, pcap_filter=""):
        ...
        # my problems are being caused here!!
        # !wlp58s0 not recognised... -> ASK MARC WHICH INTERFACE TO USE (currently using -i any)
        # prefix needs to be location of dumpcap, I've modified this from "/usr/local/bin/"
        prefix = "/usr/bin/"
        ...
        # sometimes commented out below block
