...
def kill_all_children(parent_pid):
    ...
    # Trying to kill already dead processes
    # I've added a try statement here to trya nd avoid the error...
    for child in gen_all_children_procs(parent_pid):
        try:
            child.kill()
        except:
            print("process (pid={}) is already dead...".format(child.pid))
